      ...
      <div className="max-w-7xl mx-auto w-full">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
          ...
          <div className="lg:col-span-4 flex justify-center lg:justify-end animate-fade-in opacity-0" style={{ animationDelay: '0.4s', animationFillMode: 'forwards' }}>
            <div className="bg-secondary/50 backdrop-blur-sm p-6 rounded-lg border border-border shadow-lg transition-all hover:shadow-xl">
              <h3 className="font-playfair text-xl font-medium mb-4 text-foreground">Let's Connect</h3>
              <div className="space-y-3">
                <a href="mailto:daksh.java.util@gmail.com" className="flex items-center gap-2 text-muted-foreground hover:text-primary transition-colors">
                  <span className="w-10 h-10 rounded bg-secondary flex items-center justify-center">
                    <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect width="20" height="16" x="2" y="4" rx="2"/><path d="m22 7-8.97 5.7a1.94 1.94 0 0 1-2.06 0L2 7"/></svg>
                  </span>
                  <span>daksh.java.util@gmail.com</span>
                </a>
                <a href="tel:+917024892425" className="flex items-center gap-2 text-muted-foreground hover:text-primary transition-colors">
                  <span className="w-10 h-10 rounded bg-secondary flex items-center justify-center">
